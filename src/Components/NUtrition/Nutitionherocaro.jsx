import React,{useState} from 'react';import { NextArrow, PrevArrow } from "../CarousalArrow";
import Slider from 'react-slick';
import Nutitionherocarocar from "./NUtitionherocarocard";
const Nutitionherocaro = () => {
  ...
  return (
    <Slider {...settings}>
      {heroBanners.map((image) => (
        < Nutitionherocarocar image={image} />
      ))}
    </Slider>
  );
};
...
export default Nutitionherocaro